  ...
  <div>
    <section class="styleguide segment">
      <div class="container container--narrow text">
        ...
        <p>
          Proin auctor nisl
          <nuxt-link to="/scrollmagic" class="link"
            >mattis lorem varius mattis</nuxt-link
          >. Aliquam cursus dui non ullamcorper volutpat. Suspendisse quis dui
          in ante maximus fermentum ac vitae risus.
        </p>
      </div>
    </section>
    <section class="styleguide segment segment--dark">
      <div class="container container--narrow text">
        <h1>
          Fusce fringilla nisl sed eros finibus volutpat. Praesent convallis
          elit non sapien suscipit, quis pellentesque ligula egestas.
