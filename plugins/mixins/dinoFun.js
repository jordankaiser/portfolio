  ...
  mounted: function() {
    ...
    function isDesktop() {
      ...
      function initTimelineOne() {
        ...
        const rightDino = {
          container: document.querySelector(
            '.bg-fun-right .bg-fun-right__section--two .dino-fun'
          ),
          eyeOpen: document.querySelector(
            '.bg-fun-right .bg-fun-right__section--two .dino-fun__artwork--eye-open'
          ),
          eyeClosed: document.querySelector(
            '.bg-fun-right .bg-fun-right__section--two .dino-fun__artwork--eye-closed'
          )
        }
        console.log(leftDino)
        console.log(rightDino)
        console.log(timelineOne)
